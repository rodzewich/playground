...
/// <reference path="./../../../elements/strong/IElement.ts" />
/// <reference path="./../../../elements/strong/IOptions.ts" />

module xlib.ui.element.adapters.browser.strong {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.strong.IElement<HTMLElement> {

    constructor(options?: element.elements.strong.IOptions<HTMLElement>) {
      super(options);
    }
