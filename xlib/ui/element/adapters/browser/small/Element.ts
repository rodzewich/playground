...
/// <reference path="./../../../elements/small/IElement.ts" />
/// <reference path="./../../../elements/small/IOptions.ts" />

module xlib.ui.element.adapters.browser.small {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.small.IElement<HTMLElement> {

    constructor(options?: element.elements.small.IOptions<HTMLElement>) {
      super(options);
    }
