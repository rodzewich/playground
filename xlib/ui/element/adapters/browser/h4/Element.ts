...
/// <reference path="./../../../elements/h4/IElement.ts" />
/// <reference path="./../../../elements/h4/IOptions.ts" />

module xlib.ui.element.adapters.browser.h4 {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.h4.IElement<HTMLElement> {

    constructor(options?: element.elements.h4.IOptions<HTMLElement>) {
      super(options);
    }
