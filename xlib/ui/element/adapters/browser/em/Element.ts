...
/// <reference path="./../../../elements/em/IElement.ts" />
/// <reference path="./../../../elements/em/IOptions.ts" />

module xlib.ui.element.adapters.browser.em {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.em.IElement<HTMLElement> {

    constructor(options?: element.elements.em.IOptions<HTMLElement>) {
      super(options);
    }
