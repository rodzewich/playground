...
/// <reference path="./../../../elements/h2/IElement.ts" />
/// <reference path="./../../../elements/h2/IOptions.ts" />

module xlib.ui.element.adapters.browser.h2 {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.h2.IElement<HTMLElement> {

    constructor(options?: element.elements.h2.IOptions<HTMLElement>) {
      super(options);
    }
