...
/// <reference path="./../../../elements/address/IElement.ts" />
/// <reference path="./../../../elements/address/IOptions.ts" />

module xlib.ui.element.adapters.browser.address {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.address.IElement<HTMLElement> {

    constructor(options?: element.elements.address.IOptions<HTMLElement>) {
      super(options);
