...
/// <reference path="./../../../elements/caption/IElement.ts" />
/// <reference path="./../../../elements/caption/IOptions.ts" />

module xlib.ui.element.adapters.browser.caption {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.caption.IElement<HTMLElement> {

    constructor(options?: element.elements.caption.IOptions<HTMLElement>) {
      super(options);
    ...
    public attributesDeny(): string[] {
      ...
      return super.attributesDeny().concat(["title", "lang", "xml:lang", "dir", "align", "valign"]);
    }

    public attributesAllow(): string[] {
      return super.attributesAllow().concat(["title", "lang", "xml:lang", "dir", "align", "valign"]);
    }
    ...
    public setAlign(value: string): void {
      ...
      if (temp === "") {
        ...
        if (["left", "right", "top", "bottom"].indexOf(temp) === -1) {
          throw new Error("bla bla bla");
        }
        element.setAttribute("dir", temp);
      }
