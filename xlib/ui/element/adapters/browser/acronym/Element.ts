...
/// <reference path="./../../../elements/acronym/IElement.ts" />
/// <reference path="./../../../elements/acronym/IOptions.ts" />

module xlib.ui.element.adapters.browser.acronym {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.acronym.IElement<HTMLElement> {

    constructor(options?: element.elements.acronym.IOptions<HTMLElement>) {
      super(options);
