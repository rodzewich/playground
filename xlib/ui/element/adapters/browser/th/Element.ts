...
/// <reference path="./../../../elements/th/IElement.ts" />
/// <reference path="./../../../elements/th/IOptions.ts" />

module xlib.ui.element.adapters.browser.th {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.th.IElement<HTMLElement> {

    constructor(options?: element.elements.th.IOptions<HTMLElement>) {
      super(options);
    }
