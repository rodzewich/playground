...
/// <reference path="./../../../elements/q/IElement.ts" />
/// <reference path="./../../../elements/q/IOptions.ts" />

module xlib.ui.element.adapters.browser.q {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.q.IElement<HTMLElement> {

    constructor(options?: element.elements.q.IOptions<HTMLElement>) {
      super(options);
    }
