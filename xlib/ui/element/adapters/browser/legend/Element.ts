...
/// <reference path="./../../../elements/legend/IElement.ts" />
/// <reference path="./../../../elements/legend/IOptions.ts" />

module xlib.ui.element.adapters.browser.legend {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.legend.IElement<HTMLElement> {

    constructor(options?: element.elements.legend.IOptions<HTMLElement>) {
      super(options);
    }
