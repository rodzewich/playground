...
/// <reference path="./../../../elements/dfn/IElement.ts" />
/// <reference path="./../../../elements/dfn/IOptions.ts" />

module xlib.ui.element.adapters.browser.dfn {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.dfn.IElement<HTMLElement> {

    constructor(options?: element.elements.dfn.IOptions<HTMLElement>) {
      super(options);
    }
