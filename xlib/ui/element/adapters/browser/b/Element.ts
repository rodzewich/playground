...
/// <reference path="./../../../elements/b/IElement.ts" />
/// <reference path="./../../../elements/b/IOptions.ts" />

module xlib.ui.element.adapters.browser.b {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.b.IElement<HTMLElement> {

    constructor(options?: element.elements.b.IOptions<HTMLElement>) {
      super(options);
