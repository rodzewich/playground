...
/// <reference path="./../../../elements/sub/IElement.ts" />
/// <reference path="./../../../elements/sub/IOptions.ts" />

module xlib.ui.element.adapters.browser.sub {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.sub.IElement<HTMLElement> {

    constructor(options?: element.elements.sub.IOptions<HTMLElement>) {
      super(options);
    }
