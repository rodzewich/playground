...
/// <reference path="./../../../elements/ins/IElement.ts" />
/// <reference path="./../../../elements/ins/IOptions.ts" />

module xlib.ui.element.adapters.browser.ins {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.ins.IElement<HTMLElement> {

    constructor(options?: element.elements.ins.IOptions<HTMLElement>) {
      super(options);
    }
