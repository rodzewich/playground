...
/// <reference path="./../../../elements/dd/IElement.ts" />
/// <reference path="./../../../elements/dd/IOptions.ts" />

module xlib.ui.element.adapters.browser.dd {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.dd.IElement<HTMLElement> {

    constructor(options?: element.elements.dd.IOptions<HTMLElement>) {
      super(options);
    }
