...
/// <reference path="./../../../elements/col/IElement.ts" />
/// <reference path="./../../../elements/col/IOptions.ts" />

module xlib.ui.element.adapters.browser.col {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.col.IElement<HTMLElement> {

    constructor(options?: element.elements.col.IOptions<HTMLElement>) {
      super(options);
