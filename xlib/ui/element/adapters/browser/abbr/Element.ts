...
/// <reference path="./../../../elements/abbr/IElement.ts" />
/// <reference path="./../../../elements/abbr/IOptions.ts" />

module xlib.ui.element.adapters.browser.abbr {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.abbr.IElement<HTMLElement> {

    constructor(options?: element.elements.abbr.IOptions<HTMLElement>) {
      super(options);
