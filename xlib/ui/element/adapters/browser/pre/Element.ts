...
/// <reference path="./../../../elements/pre/IElement.ts" />
/// <reference path="./../../../elements/pre/IOptions.ts" />

module xlib.ui.element.adapters.browser.pre {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.pre.IElement<HTMLElement> {

    constructor(options?: element.elements.pre.IOptions<HTMLElement>) {
      super(options);
    }
    ...
    public allowTags(): string[] {
      return ["a", "abbr", "acronym", "b", "bdo", "big", "br", "button", "cite", "code", "del", "dfn", "em", "i", "input", "ins", "kbd", "label", "map", "q", "samp", "script", "select", "small", "span", "strong", "sub", "sup", "textarea", "tt", "var"];
    }
