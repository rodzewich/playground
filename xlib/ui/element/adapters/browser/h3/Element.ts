...
/// <reference path="./../../../elements/h3/IElement.ts" />
/// <reference path="./../../../elements/h3/IOptions.ts" />

module xlib.ui.element.adapters.browser.h3 {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.h3.IElement<HTMLElement> {

    constructor(options?: element.elements.h3.IOptions<HTMLElement>) {
      super(options);
    }
