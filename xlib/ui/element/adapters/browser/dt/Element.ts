...
/// <reference path="./../../../elements/dt/IElement.ts" />
/// <reference path="./../../../elements/dt/IOptions.ts" />

module xlib.ui.element.adapters.browser.dt {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.dt.IElement<HTMLElement> {

    constructor(options?: element.elements.dt.IOptions<HTMLElement>) {
      super(options);
    }
