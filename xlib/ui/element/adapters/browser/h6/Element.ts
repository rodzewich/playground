...
/// <reference path="./../../../elements/h6/IElement.ts" />
/// <reference path="./../../../elements/h6/IOptions.ts" />

module xlib.ui.element.adapters.browser.h6 {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.h6.IElement<HTMLElement> {

    constructor(options?: element.elements.h6.IOptions<HTMLElement>) {
      super(options);
    }
