...
/// <reference path="./../../../elements/big/IElement.ts" />
/// <reference path="./../../../elements/big/IOptions.ts" />

module xlib.ui.element.adapters.browser.big {

  import IEvent = elements.IEvent;

  export class Element extends browser.Element implements element.elements.big.IElement<HTMLElement> {

    constructor(options?: element.elements.big.IOptions<HTMLElement>) {
      super(options);
