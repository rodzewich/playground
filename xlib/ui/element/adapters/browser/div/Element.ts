...
module xlib.ui.element.adapters.browser.div {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.div.IElement<HTMLElement> {

    constructor(options?: element.elements.div.IOptions<HTMLElement>) {
      super(options);
    }
