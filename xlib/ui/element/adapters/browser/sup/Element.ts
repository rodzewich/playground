...
/// <reference path="./../../../elements/sup/IElement.ts" />
/// <reference path="./../../../elements/sup/IOptions.ts" />

module xlib.ui.element.adapters.browser.sup {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.sup.IElement<HTMLElement> {

    constructor(options?: element.elements.sup.IOptions<HTMLElement>) {
      super(options);
    }
