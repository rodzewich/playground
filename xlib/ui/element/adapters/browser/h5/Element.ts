...
/// <reference path="./../../../elements/h5/IElement.ts" />
/// <reference path="./../../../elements/h5/IOptions.ts" />

module xlib.ui.element.adapters.browser.h5 {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.h5.IElement<HTMLElement> {

    constructor(options?: element.elements.h5.IOptions<HTMLElement>) {
      super(options);
    }
