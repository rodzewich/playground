...
/// <reference path="./../../../elements/tfoot/IElement.ts" />
/// <reference path="./../../../elements/tfoot/IOptions.ts" />

module xlib.ui.element.adapters.browser.tfoot {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.tfoot.IElement<HTMLElement> {

    constructor(options?: element.elements.tfoot.IOptions<HTMLElement>) {
      super(options);
    }
