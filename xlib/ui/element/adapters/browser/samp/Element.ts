...
/// <reference path="./../../../elements/samp/IElement.ts" />
/// <reference path="./../../../elements/samp/IOptions.ts" />

module xlib.ui.element.adapters.browser.samp {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.samp.IElement<HTMLElement> {

    constructor(options?: element.elements.samp.IOptions<HTMLElement>) {
      super(options);
    }
