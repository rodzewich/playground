...
/// <reference path="./../../../elements/kbd/IElement.ts" />
/// <reference path="./../../../elements/kbd/IOptions.ts" />

module xlib.ui.element.adapters.browser.kbd {

  import IEvent = element.elements.IEvent;

  export class Element extends browser.Element implements element.elements.kbd.IElement<HTMLElement> {

    constructor(options?: element.elements.kbd.IOptions<HTMLElement>) {
      super(options);
    }
