    ...
    function connect() {
        ...
        if (!connectLock) {
            if (!connected) {
                deferred([
                    function (next) {
                        childProcess = spawn(process.execPath, ["./WorkerProcess.js", temporaryDirectory], {cwd: __dirname});
                    ...
                    function () {
                        socket = net.createConnection(getSocketPath(), function () {
                            onComplete(null);
                        });
...
var client = new WorkerClient({temporaryDirectory: __dirname});
