...
function WorkerClient(options) {
    ...
    function getResourceLocation() {
        return path.join(temporaryDirectory, "less-" + self.getPid() + ".sock");
    }
    ...
    temporaryDirectory = String(options.temporaryDirectory); // todo: check directory

    var sourcesDirectory = String(options.sourcesDirectory); // todo: check directory
    var importDirectories = options.importDirectories; // todo: check directories
