...
interface IDaemon extends IDaemonBase {
    ...
    metadataMemoryLocation:string;
    binaryMemoryLocation:string;
    gzipMemoryLocation:string;
    lockMemoryLocation:string;
    metadataMemoryTimeout:number;
    binaryMemoryTimeout:number;
    gzipMemoryTimeout:number;
    lockMemoryTimeout:number;
    memoryTimeout:number;
    getMemoryTimeout():number;
    setMemoryTimeout(timeout:number):void;
    setMetadataMemoryTimeout(timeout:number):void;
    getMetadataMemoryTimeout():number;
    setBinaryMemoryTimeout(timeout:number):void;
    getBinaryMemoryTimeout():number;
    setGzipMemoryTimeout(timeout:number):void;
    getGzipMemoryTimeout():number;
    setLockMemoryTimeout(timeout:number):void;
    getLockMemoryTimeout():number;
    setMemoryLocation(location:string):void;
    getMemoryLocation():string;
    setMetadataMemoryLocation(location:string):void;
    getMetadataMemoryLocation():string;
    setBinaryMemoryLocation(location:string):void;
    getBinaryMemoryLocation():string;
    setGzipMemoryLocation(location:string):void;
    getGzipMemoryLocation():string;
    setLockMemoryLocation(location:string):void;
    getLockMemoryLocation():string;
    getNamespace():string;
