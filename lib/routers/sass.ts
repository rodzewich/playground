...
import IManager = require("../cssPreProcessorForSass/manager/IManager");
import Manager = require("../cssPreProcessorForSass/manager/Manager");
import IResponse = require("../cssPreProcessorForSass/client/IResponse");
