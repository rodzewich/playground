...
import IManager = require("../cssPreProcessorForStylus/manager/IManager");
import Manager = require("../cssPreProcessorForStylus/manager/Manager");
import IResponse = require("../cssPreProcessorForStylus/client/IResponse");
