...
module config {
    ...
    export const DEFAULT_CSS_SOCKET:string = path.join(DEFAULT_PROJECT_TEMPORARY_DIRECTORY, "css.sock");
    export const DEFAULT_LESS_SOCKET:string = path.join(DEFAULT_PROJECT_TEMPORARY_DIRECTORY, "less.sock");
    export const DEFAULT_SASS_SOCKET:string = path.join(DEFAULT_PROJECT_TEMPORARY_DIRECTORY, "sass.sock");
    export const DEFAULT_STYLUS_SOCKET:string = path.join(DEFAULT_PROJECT_TEMPORARY_DIRECTORY, "stylus.sock");
